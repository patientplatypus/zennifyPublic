<template>
  <div class='Auth'>
    <div class='card1' :style="{marginLeft: '37.5vw'}">
      <h2>
        authentication
      </h2>
      <p>
      ...
      <div :style="{marginTop: '2.5vh', marginLeft: '9vw'}">
        <input readonly class='button1' value="register!" type='button' @click="handleUser('register')"/>
        <input readonly class='button1' value="login!" type='button' @click="handleUser('login')"/>
        <input readonly class='button1' value="testJWT!" type='button' @click="handleUser('testJWT')"/>
      </div>
      </div>
    </div>
</template>
